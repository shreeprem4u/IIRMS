...
public class IIRMSQuery extends IIRMSVisualization {
	...
	public IIRMSQuery() throws Exception {
		...
		conn = DriverManager.getConnection("jdbc:postgresql://117.240.224.20:5432/" + dbName, "researcher", "researcher");
		...
		// Defining the background, to be added last
				URL url = new URL("http://117.240.224.20/html/pics/queryMain.jpg");
		...
		// Defining the type components
				url = new URL("http://117.240.224.20/html/pics/roomImage.jpg");
		...
		url = new URL("http://117.240.224.20/html/pics/wallImage.jpeg");
		icon = new ImageIcon(url);
		...
		url = new URL("http://117.240.224.20/html/pics/doorImage.jpeg");
		icon = new ImageIcon(url);
		...
		url = new URL("http://117.240.224.20/html/pics/windowImage.jpeg");
		icon = new ImageIcon(url);
		...
		url = new URL("http://117.240.224.20/html/pics/stairImage.jpg");
		icon = new ImageIcon(url);
...
//		}
	...
	public static void DBConnectionQuery() throws Exception {
		...
		conn = DriverManager.getConnection("jdbc:postgresql://117.240.224.20:5432/" + IIRMSQueryInterface.dbNameSelected, "researcher",
				"researcher");
	}
