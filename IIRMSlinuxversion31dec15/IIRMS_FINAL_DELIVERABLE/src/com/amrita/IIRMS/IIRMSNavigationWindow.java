...
public class IIRMSNavigationWindow {
    ...
    public IIRMSNavigationWindow() throws Exception {
      ...
      //Defining the side image
        URL url = new URL("http://117.240.224.20/html/pics/mock_building.png");
        ...
        URL url1=new URL("http://117.240.224.20/html/pics/config.png");
        ...
        //Defining the side image.
        URL url2=new URL("http://117.240.224.20/html/pics/MockBuilding.jpeg");
       ...
       // mainPanel_NavigationIIRMS.add(bui_NavigationIIRMS);
        ...
        URL url3=new URL("http://117.240.224.20/html/pics/appln.png");
        ...
        URL url4=new URL("http://117.240.224.20/html/pics/background.jpg");
