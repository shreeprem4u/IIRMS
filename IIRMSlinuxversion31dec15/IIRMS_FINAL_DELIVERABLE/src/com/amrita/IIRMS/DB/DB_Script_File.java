...
public class DB_Script_File {
    ...
    public DB_Script_File() throws Exception {
        ...
        URL url= new URL("http://117.240.224.20/html/pics/help.png");
        ...
        bCreate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    stmt2.execute(query);
                    conn.close();
                    conn = DriverManager.getConnection("jdbc:postgresql://117.240.224.20:5432/" + tDBName.getText().toLowerCase() + "_building", "researcher", "researcher");
