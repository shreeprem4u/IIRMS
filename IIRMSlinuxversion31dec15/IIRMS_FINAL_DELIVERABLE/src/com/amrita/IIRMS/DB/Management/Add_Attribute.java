            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    if ((!cBuilding.getSelectedItem().equals(" ")) || (!cColumnType.getSelectedItem().equals(" ")) || (!tColumnName.getText().equals(" ")) || (!cTableNamesFinal.getSelectedItem().equals(" "))) {
                        Connection connOk = DriverManager.getConnection("jdbc:postgresql://117.240.224.20:5432/" + (String) cBuilding.getSelectedItem(),
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    if (!cBuilding.getSelectedItem().equals(" ")) {
                        String connValue = "jdbc:postgresql://117.240.224.20:5432/" + (String) cBuilding.getSelectedItem();
