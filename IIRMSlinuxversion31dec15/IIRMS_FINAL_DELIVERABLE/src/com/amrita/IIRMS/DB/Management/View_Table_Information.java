...
public class View_Table_Information extends JFrame {
    ...
    public View_Table_Information() throws Exception{
        ...
        cBuilding.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    Connection connIn = DriverManager.getConnection("jdbc:postgresql://117.240.224.20:5432/" + cBuilding.getSelectedItem(),
        ...
        bOk.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    Connection connIn2 = DriverManager.getConnection("jdbc:postgresql://117.240.224.20:5432/" + cBuilding.getSelectedItem(),
                            "researcher", "researcher");
