...
public class IIRMSApplicationInterface extends JFrame {
    ...
    public static java.util.List<String> getDBNames() throws Exception {
        ...
        conn = DriverManager.getConnection("jdbc:postgresql://117.240.224.20:5432/", "researcher", "researcher");
    ...
    public IIRMSApplicationInterface() throws Exception {
        ...
        url=new URL("http://117.240.224.20/html/pics/indoor-query.png");
        ...
        url=new URL("http://117.240.224.20/html/pics/igml-docView.png");
        ...
        url=new URL("http://117.240.224.20/html/pics/igml-graph.png");
